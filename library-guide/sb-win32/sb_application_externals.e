...
feature { SB_APPLICATION } -- External features
   ...
   ext_make(app_: SB_APPLICATION; hinstance_ : POINTER;
            ...
            handle_signal_, handle_refresher_, handle_window_event: POINTER): POINTER
      external "C"
   ...
   ext_remove_timeout(p: POINTER; t: POINTER)
      external "C"
      alias "sb_application_remove_timeout"
      end

   ext_add_chore(p: POINTER; tgt: SB_MESSAGE_HANDLER; sel: INTEGER): POINTER
      external "C"
      alias "sb_application_add_chore"
      end

   ext_remove_chore(p: POINTER; t: POINTER)
      external "C"
      alias "sb_application_remove_chore"
      end

   ext_add_signal (p: POINTER; sig: INTEGER; tgt: SB_MESSAGE_HANDLER; sel: INTEGER; 
                   immediate: BOOLEAN; flags: INTEGER)
      external "C"
      alias  "sb_application_add_signal"
      end

   ext_remove_signal (p: POINTER; sig: INTEGER)
      external "C" 
      alias "sb_application_remove_signal"
      end

   ext_add_input (p: POINTER; fd: INTEGER; mode: INTEGER;
                  tgt: SB_MESSAGE_HANDLER; sel: INTEGER): BOOLEAN
      external "C"
      alias "sb_application_add_input"
      end

   ext_remove_input (p: POINTER; fd: INTEGER; mode: INTEGER): BOOLEAN
      external "C"
      alias "sb_application_remove_input"
      end

   ext_run_one_event(p: POINTER; p1: POINTER)
      external "C"
      alias "sb_application_run_one_event"
      end

   ext_open_display(p: POINTER; p1: POINTER): BOOLEAN
      external "C"
      alias "sb_application_open_display"
      end

   ext_close_display(p: POINTER): BOOLEAN
      external "C"
      alias "sb_application_close_display"
      end

   ext_get_display(p: POINTER): POINTER
      external "C"
      alias "sb_application_get_display"
      end

   ext_peek_event(p: POINTER): BOOLEAN
      external "C"
      alias "sb_application_peek_event"
      end

   ext_get_application: SB_APPLICATION
      external "C"
      alias "sb_application_get_application"
      end

   ext_get_sbwnd_from_createstruct(s: INTEGER): SB_WINDOW
      external "C"
      alias "sb_application_sbwnd_from_createstruct"
      end

   ext_get_stipple(p: POINTER; index: INTEGER): POINTER
      external "C"
