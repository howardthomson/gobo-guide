...
--	c_get_quad  (p: POINTER; offset: INTEGER): INTEGER_64	is external "C" end
	c_get_float (p: POINTER; offset: INTEGER): DOUBLE		is external "C" end
	c_get_double(p: POINTER; offset: INTEGER): DOUBLE		is external "C" end

	c_get_int8  (p: POINTER; offset: INTEGER): INTEGER   is external "C" alias "c_get_byte"  end
	c_get_int16 (p: POINTER; offset: INTEGER): INTEGER	 is external "C" alias "c_get_short" end
...
--	c_put_quad   (p: POINTER; offset: INTEGER; value: BIT 64   ) is external "C" end
	c_put_float  (p: POINTER; offset: INTEGER; value: REAL     ) is external "C" end
	c_put_double (p: POINTER; offset: INTEGER; value: DOUBLE   ) is external "C" end
