	...
	make_cursors
		...
		do
			...
			create cursors.make (1, Def_rotate_cursor + 1)
				...
				-- Stock cursors
			create new_cursor.make_from_stock (CURSOR_ARROW);	cursors.put (new_cursor, Def_arrow_cursor)
			create new_cursor.make_from_stock (CURSOR_RARROW);	cursors.put (new_cursor, Def_rarrow_cursor)
			create new_cursor.make_from_stock (CURSOR_IBEAM);	cursors.put (new_cursor, Def_text_cursor)
...
feature {NONE} -- Initialization
	...
	make
		...
		do
		--	make_sb ("", "")
			Precursor {EV_APPLICATION_IMP_DEF}
