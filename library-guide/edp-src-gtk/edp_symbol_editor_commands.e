...
--	Id_delete			: INTEGER is once Result := FRAME_ID_LAST + 14 end
	...
	ID_CURSOR_UP		: INTEGER once Result := FRAME_ID_LAST + 18 end
	ID_CURSOR_DOWN		: INTEGER once Result := FRAME_ID_LAST + 19 end

	ID_CURSOR_HOME_LINE	: INTEGER once Result := FRAME_ID_LAST + 20 end
	ID_CURSOR_END_LINE	: INTEGER once Result := FRAME_ID_LAST + 21 end

	Id_last				: INTEGER once Result := FRAME_ID_LAST + 22 end
