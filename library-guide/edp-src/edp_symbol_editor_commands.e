...
expanded class EDP_SYMBOL_EDITOR_COMMANDS
...
--	Id_delete			: INTEGER is once Result := FRAME_ID_LAST + 14 end
	...
	ID_CURSOR_UP		: INTEGER is once Result := FRAME_ID_LAST + 18 end
	ID_CURSOR_DOWN		: INTEGER is once Result := FRAME_ID_LAST + 19 end

	ID_CURSOR_HOME_LINE	: INTEGER is once Result := FRAME_ID_LAST + 20 end
	ID_CURSOR_END_LINE	: INTEGER is once Result := FRAME_ID_LAST + 21 end

	Id_last				: INTEGER is once Result := FRAME_ID_LAST + 22 end
