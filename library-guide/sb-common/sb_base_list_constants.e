...
feature -- List styles
	...
	LIST_EXTENDEDSELECT	: INTEGER is 0x00000000 -- 00 0000 0000 0000 0000 0000B;
		-- Extended selection mode allows for drag-selection of ranges of items
	LIST_SINGLESELECT	: INTEGER is 0x00100000-- 01 0000 0000 0000 0000 0000B;
		-- Single selection mode allows up to one item to be selected
	LIST_BROWSESELECT	: INTEGER is 0x00200000 -- 10 0000 0000 0000 0000 0000B;
		-- Browse selection mode enforces one single item to be selected at all times
	LIST_MULTIPLESELECT	: INTEGER is 0x00300000 -- 11 0000 0000 0000 0000 0000B;
