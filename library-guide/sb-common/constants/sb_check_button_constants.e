...
feature -- Check Button flags
	...
	CHECKBUTTON_AUTOGRAY	: INTEGER is 0x00800000	-- 1000 0000 0000 0000 0000 0000B;
		-- Automatically gray out when not updated
	CHECKBUTTON_AUTOHIDE	: INTEGER is 0x01000000	-- 1 0000 0000 0000 0000 0000 0000B;
		-- Automatically hide when not updated
	CHECKBUTTON_PLUS		: INTEGER is 0x02000000	-- 10 0000 0000 0000 0000 0000 0000B;
		-- Draw a + for unchecked and - for checked

	CHECKBUTTON_NORMAL: INTEGER is
		once
			Result := (JUSTIFY_NORMAL | ICON_BEFORE_TEXT)
		end

	CHECKBUTTON_MASK: INTEGER is
		once
