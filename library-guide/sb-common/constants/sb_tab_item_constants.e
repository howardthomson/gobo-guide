...
feature -- Tab Item orientations which affect border
	...
	TAB_TOP		: INTEGER = 0			-- Top side tabs
	TAB_LEFT	: INTEGER = 0x00800000	-- Left side tabs
	TAB_RIGHT	: INTEGER = 0x01000000	-- Right side tabs
	TAB_BOTTOM	: INTEGER = 0x01800000	-- Bottom side tabs

	TAB_TOP_NORMAL: INTEGER
      	once
         	Result := JUSTIFY_NORMAL | ICON_BEFORE_TEXT | TAB_TOP | Frame_raised | Frame_thick
      	end

	TAB_BOTTOM_NORMAL: INTEGER
      	once
         	Result :=  JUSTIFY_NORMAL | ICON_BEFORE_TEXT | TAB_BOTTOM | Frame_raised | Frame_thick
      	end

	TAB_LEFT_NORMAL: INTEGER
      	once
         	Result := JUSTIFY_LEFT | JUSTIFY_CENTER_Y | ICON_BEFORE_TEXT | TAB_LEFT | Frame_raised | Frame_thick
      	end

	TAB_RIGHT_NORMAL: INTEGER
      	once
