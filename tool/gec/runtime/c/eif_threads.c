...
void
eif_thr_cond_broadcast (void *a_cond_ptr)
{
}

void
eif_thr_cond_signal (void *a_cond_ptr)
{
}

void
eif_thr_cond_wait (void *a_cond_ptr, void *a_mutex_ptr)
{
}

int
eif_thr_cond_wait_with_timeout (void *a_cond_ptr, void *a_mutex_ptr, int a_timeout)
{
}

void
eif_thr_cond_destroy (void *a_mutex_ptr)
{
}
...
void
eif_thr_create_with_attr (void *current_obj, void *init_func, void *attr)
...
boolean_t
eif_thr_wait_with_timeout (void *term, uint64_t a_timeout_ms)
			/* The calling C thread waits for the current Eiffel thread to
			 * terminate.
			 */
{
...
void *	eif_thr_sem_create (int count)
{
}

void	eif_thr_sem_wait (void *a_sem_pointer)
{
}

void	eif_thr_sem_post (void *a_sem_pointer)
{
}

boolean_t	eif_thr_sem_trywait (void *a_sem_pointer)
{
}

void	eif_thr_sem_destroy (void *a_sem_pointer)
{
}